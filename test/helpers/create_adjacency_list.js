...
describe('create adjacency list', () => {
  ...
  it('should create an accurate adjacency list', () => {
    ...
    expect(list['CS 1337']).to.be.undefined;

  });

  it('should create an accurate followed adjacency list', () => {

    let list = createAdjacencyList(['CS 3345'], true);
    ...
    expect(list['CS 1337']).to.not.be.undefined;
